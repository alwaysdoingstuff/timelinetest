Timeline Core version 0.9.4 is now available from:

  https://timeline.org/bin/0.9.4/
...
this update is incompatible with the Timeline system and could lead to consensus
forks.

Timeline Core released binaries from https://timeline.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~timeline/+archive/ubuntu/timeline
- A third-party or self-compiled Timeline Core

upgrade to Timeline Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
