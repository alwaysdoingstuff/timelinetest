Timeline Core version 0.10.4 is now available from:

  <https://timeline.org/bin/timeline-core-0.10.4/>
...
- #6953 `43c2789` Split timeline-tx into its own package
- #6953 `dfe0d4d` Include timeline-tx binary on Debian/Ubuntu
