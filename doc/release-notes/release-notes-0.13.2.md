Timeline Core version 0.13.2 is now available from:

  <https://timeline.org/bin/timeline-core-0.13.2/>
...
- #8908 `4a974b2` Update timeline-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow timeline-tx to create v2 transactions (TIMELINEdrak)
