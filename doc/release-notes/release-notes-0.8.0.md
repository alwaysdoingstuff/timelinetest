Timeline-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/timeline/files/Timeline/timeline-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Timeline
...
New/changed settings (command-line or timeline.conf file)
--------------------------------------------------------
