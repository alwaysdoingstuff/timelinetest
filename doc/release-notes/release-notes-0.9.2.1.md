Timeline Core version 0.9.2.1 is now available from:

  https://timeline.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TIMELINE to 0.01 TIMELINE
...
- Fix "Start timeline on system login"
