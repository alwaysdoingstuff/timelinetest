Timeline version 0.5.4 is now available for download at:
http://sourceforge.net/projects/timeline/files/Timeline/timeline-0.5.4/
...
http://gitorious.org/timeline/timelined-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Timeline-Qt notifications under Growl 1.3.
Increase required age of Timeline-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTimeline properly when installing Timeline-Qt over it. (Windows)
