...
Timeline Core version *version* is now available from:

  <https://timeline.org/bin/timeline-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Timeline Core is now 4.8. No effort will be
