...
>>>>>>> parent of a1cb4f6... chainparams
        ...
        vSeeds.emplace_back("timelinehub.org", true); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("timelinehub.org", true); // Matt Corallo, only supports x9
        vSeeds.emplace_back("timelinehub.org", false); // Luke Dashjr
        vSeeds.emplace_back("timelinehub.org", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("timelinehub.org", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("timelinehub.org", true); // Peter Todd, only supports x1, x5, x9, and xd
        ...
        chainTxData = ChainTxData{
            ...
            1390747675, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 8 * 60; // one week
        consensus.nPowTargetSpacing = 120;
        ...
        genesis = CreateGenesisBlock(1296688602, 2091634749, 0x1e0ffff0, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("timelinehub.org", true);
        vSeeds.emplace_back("timelinehub.org", true);
        vSeeds.emplace_back("timelinehub.org", false);
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 8 * 60; // week
