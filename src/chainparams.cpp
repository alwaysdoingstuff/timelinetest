...
// Copyright (c) 2014-2015 The timeline developers
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("207.68.212.54", "207.68.212.54"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();vSeeds.push_back(CDNSSeedData("207.68.212.54", "207.68.212.54"));
